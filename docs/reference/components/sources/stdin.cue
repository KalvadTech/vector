...
components: sources: stdin: {
	...
	support: {
		...
		notices: [
			#"""
				If the `stdin` source is the only source, Vector will automatically
				shutdown when the `stdin` pipe closes.
				"""#,
		]
	}
	...
	output: logs: line: {
		description: "An individual line from STDIN."
		fields: {
			host:      fields._localhost
			message:   fields._raw_message
